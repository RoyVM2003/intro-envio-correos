...
export function PanelLoginPage() {
  ...
  return (
    <div id="panelLoginPage" className="login-screen">
      ...
      <div className="login-screen-inner">
        ...
        <form id="formPanelLogin" onSubmit={handleLogin} className="login-form">
          <input
            type="email"
            id="panelLoginEmail"
        ...
        {showVerify && (
          <div className="login-verify">
            ...
            <form onSubmit={handleVerify}>
              <FormGroup label="Código" id="verifyCodePanel">
                <input
                  type="text"
                  id="verifyCodePanel"
                  value={verifyCode}
        ...
        <div className="modal-overlay" onClick={() => setShowForgot(false)}>
          <div className="modal-box" onClick={(e) => e.stopPropagation()}>
            <div className="modal-header">
              ...
              <button type="button" className="modal-close" onClick={() => setShowForgot(false)} aria-label="Cerrar">
            ...
            >
              <FormGroup label="Correo electrónico" id="forgotEmailPanel">
                <input
                  type="email"
                  id="forgotEmailPanel"
                  value={forgotEmail}
            ...
            <button type="button" className="btn btn-secondary modal-back" onClick={() => setShowForgot(false)}>
